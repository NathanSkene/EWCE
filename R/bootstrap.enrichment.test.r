...
#' @param hits Array of MGI gene symbols containing the target gene list. Must be HGNC symbols if geneSizeControl=TRUE
#' @param bg Array of MGI gene symbols containing the background gene list. Must be HGNC symbols if geneSizeControl=TRUE
