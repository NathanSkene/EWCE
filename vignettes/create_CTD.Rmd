...
```{r, style="max-height: 100px;", warning=FALSE}
...
not significantly differentially expressed across cell-types. Multiple DEG methods are currently available (see `?drop_uninformative_genes` for up-to-date info). 
